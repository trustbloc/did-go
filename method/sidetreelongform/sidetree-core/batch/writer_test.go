...
import (
	...
	"github.com/trustbloc/did-go/method/sidetreelongform/sidetree-core/batch/opqueue"
	...
	"github.com/trustbloc/did-go/method/sidetreelongform/sidetree-core/versions/1_0/txnprovider"
...
func getBatchFiles(
	cc cas.Client, anchor string) (*models.CoreIndexFile, *models.ProvisionalIndexFile, *models.ChunkFile, error) {
...
func TestStartWithExistingItems(t *testing.T) {
	const (
		numOperations         = 23
		maxOperationsPerBatch = 4
		numBatchesExpected    = 6
	)
...
func TestProcessError(t *testing.T) {
	t.Run("process operation error", func(t *testing.T) {
		...
		invalidQueue := []*operation.QueuedOperationAtTime{{
