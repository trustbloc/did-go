...
import (
	...
	internaljws "github.com/trustbloc/did-go/method/sidetreelongform/sidetree-core/internal/jws"
...
//
// -- authentication: the key MUST be included by reference (full id) in the authentication
// section of the resolved DID Document
...
func (t *Transformer) processKeys(internal document.DIDDocument,
	resolutionResult *document.ResolutionResult) error {
